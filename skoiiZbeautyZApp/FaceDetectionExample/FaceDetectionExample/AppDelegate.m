...
-(void)markFaces:(UIImageView *)facePicture
{
    ...
    for(CIFaceFeature* faceFeature in features)
    {
        ...
        if(faceFeature.hasLeftEyePosition)
        {
            ...
            UIImageView* eye=[[UIImageView alloc] initWithFrame:CGRectMake(faceFeature.leftEyePosition.x-faceWidth*0.15, faceFeature.leftEyePosition.y-faceWidth*0.15, faceWidth*0.3, faceWidth*0.3)];
        ...
        if(faceFeature.hasRightEyePosition)
        {
            ...
            UIImageView* eye1=[[UIImageView alloc] initWithFrame:CGRectMake(faceFeature.rightEyePosition.x-faceWidth*0.15, faceFeature.rightEyePosition.y-faceWidth*0.15, faceWidth*0.3, faceWidth*0.3)];
        ...
        if(faceFeature.hasMouthPosition)
        {
            ...
            UIImageView* mouthPic=[[UIImageView alloc] initWithFrame:CGRectMake(faceFeature.mouthPosition.x-faceWidth*0.2, faceFeature.mouthPosition.y-faceWidth*0.15, faceWidth*0.4, faceWidth*0.2)];
            [mouthPic setImage:[UIImage imageNamed:@"mouth.png"]];
            ...
            [self.window addSubview:mouthPic];
        }
    }
}
